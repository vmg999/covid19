    ...
    _createKeys() {
      ...
      document.querySelectorAll(".use-keyboard-input").forEach(element => {
        element.addEventListener("keydown", (e)=>{
            let ind = keyCodeLayout.indexOf(e.which);
      ...
      keyLayout.forEach(key => {
        ...
        switch (key) {
          ...
          default:  // ---------------- main keys --------------------------------------------------
            ...
            let keyRu = keyRuLayout[keyLayout.indexOf(key)];
            ...
            keyElement.addEventListener("click", () => {
                let val = (this.properties.capsLock && !this.properties.shift) ? keyElement.textContent.toUpperCase() : keyElement.textContent;
